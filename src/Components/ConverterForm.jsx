...
const ConverterForm = () => {
  ...
  const getExhangeRate = async () => {
    ...
    const API_URL = `https://v6.exchangerate-api.com/v6/7b73f65eebad88545780abee/pair/${fromCurrency}/${toCurrency}`;
...
useEffect(() => getExhangeRate, []);
  ...
  return (
    <form className="converter-form" onSubmit={handleFormSubmit}>
      ...
      <p className="value-result">{result}</p>
    </form>
  );
};
